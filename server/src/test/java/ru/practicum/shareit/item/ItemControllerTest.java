...
class ItemControllerTest {
    ...
    void getAllShouldReturnStatusOk() {
        ...
        when(itemService.getUsersItems(userId, from, size)).thenReturn(itemsDtoToExpect);
    ...
    void searchItemsShouldReturnStatusOk() {
        ...
        when(itemService.findItemsOnText(text)).thenReturn(itemsDtoToExpect);
    ...
    @Test
    @SneakyThrows
    void createCommentWhenCommentIsValid() {
