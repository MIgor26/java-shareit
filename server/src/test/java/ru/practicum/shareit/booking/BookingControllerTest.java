...
class BookingControllerTest {
    ...
    void getByIdWhenBookingIsValid() {
        ...
        when(bookingService.findBooking(user.getId(), bookingId)).thenReturn(bookingDtoOut);
    ...
    void getAllShouldReturnStatusIsOk() {
        ...
        when(bookingService.findByBooker(user.getId(), BookingState.ALL.toString(), 0, 10))
    ...
    void getAllByOwner() {
        ...
        when(bookingService.findByOwner(user.getId(), BookingState.ALL.toString(), 0, 10))
                .thenReturn(List.of(bookingDtoOut));
